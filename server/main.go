...
func main() {
	...
	fmt.Printf("Welcome to main")
	router := mux.NewRouter()

	router.HandleFunc("/", RedirectHandler).Methods("OPTIONS", "GET")
	router.HandleFunc("/people", controllers.GetPeople).Methods("OPTIONS", "GET")
	...
	// )
	// router.Use(cors)
	fmt.Printf("Welcome to main2")

	log.Fatal(http.ListenAndServe(":9090", router))
	fmt.Printf("Welcome to main3")
